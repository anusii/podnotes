...
ElevatedButton shareNote(Map<dynamic, dynamic> noteData, BuildContext context, Map authData, String webId) {
  ...
  ElevatedButton editNote(BuildContext context, Map<dynamic, dynamic> noteData, Map authData, String webId) {
    return ElevatedButton.icon(
      icon: const Icon(
        Icons.edit,
        color: Colors.white,
